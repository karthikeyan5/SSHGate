...
You are registering a new server with SSHGate. The user invoked `/sshgate:add <alias> <user@host>[:port]`.
...
If arguments are missing, print the argument-hint and stop. Do not prompt the user inline; this command is scriptable.
