...
//   - ExecWithRedaction runs a shell command via /bin/sh -c, streaming
//     stdout/stderr to the caller (optionally through the secrets redactor)
//     and forwarding SIGTERM/SIGINT to the child.
