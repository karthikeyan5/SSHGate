// Package signerserver is the hosted signer-server: the v2 evolution
// of the local signer daemon. It serves an HTTPS API over which
...
// and returns signed payloads compatible with the existing gate
// verification path.
//
...
//	doc.go         — this file
//	cmd/signer-server/main.go — entry point
